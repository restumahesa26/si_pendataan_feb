...
<div class="card mb-5">
    <div class="card-body">
        <a href="{{ route('data-berita.create') }}" class="btn btn-sm px-4 btn-primary mb-3">Tambah Data Berita</a>
                    ...
                    @forelse ($items as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('data-berita.destroy', $item->id) }}" class="d-inline" method="POST">
                                    @csrf
                                    @method('DELETE')
