...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Data Organisasi Mahasiswa & Alumni</h1>
    <ol class="breadcrumb">
...
<div class="card mb-5">
    <div class="card-body">
        <a href="{{ route('data-organisasi.cetak') }}" class="btn btn-primary mb-3" target="_blank">Cetak Laporan</a>
                    ...
                    @forelse ($items as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                @endif
                                <form action="{{ route('data-organisasi.destroy', $item->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img src="{{ asset('storage/assets/file-sertifikat-organisasi/' . $item2->file_sertifikat) }}" alt="" style="width: 800px">
            </div>
        </div>
    </div>
</div>
